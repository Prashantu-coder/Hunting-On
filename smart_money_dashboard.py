...
def authenticate_google_sheets():
    ...
    creds = ServiceAccountCredentials.from_json_keyfile_name('C:\Users\Dell\Downloads\quantexo-458612-3f15459a6740.json', scope)  # Replace 'credentials.json' with your credentials file path
